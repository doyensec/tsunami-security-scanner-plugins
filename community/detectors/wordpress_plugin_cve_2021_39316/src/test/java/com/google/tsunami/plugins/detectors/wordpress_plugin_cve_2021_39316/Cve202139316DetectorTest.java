...
public final class Cve202139316DetectorTest {

  private final FakeUtcClock fakeUtcClock =
      FakeUtcClock.create().setNow(Instant.parse("2020-01-01T00:00:00.00Z"));

  @Inject private CVE202139316VulnDetector detector;
  ...
  public void setUp() {
    ...
    Guice.createInjector(
            ...
            new CVE202139316DetectorBootstrapModule(),
  ...
  private void mockWebResponse(int statusCode, String body) throws IOException {
